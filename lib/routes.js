...
FlowRouter.route("/", {
    name: 'home',
    action() {
        BlazeLayout.render('mainLayout', { main:'principalmural',topbar :'topbar',right:'chatLayout',left:'datos'});
    }
});
...
FlowRouter.route("/perfilamigo",{
    ...
    action(){
        BlazeLayout.render('mainLayout',{main:'perfilAmigo',topbar:'topbar'});
    }
});