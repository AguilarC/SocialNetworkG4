...
FlowRouter.subscriptions = function() {
        ...
        this.register("loadSolicitudes",Meteor.subscribe("getSolicitudes",Meteor.userId()));
        this.register("loadAmigos",Meteor.subscribe("getAmigos",Meteor.userId()));
    },  
FlowRouter.route("/", {
    name: 'home',
    action() {
        BlazeLayout.render('mainHome', { main: 'homeLayout',topbar :'topbar',footer:'footer'});
    }
});
FlowRouter.route("/editPerfil", {
    name: 'editPerfil',
    subscriptions:function(params,queryParams){
        this.register("loaddatos", Meteor.subscribe('getdatos',Meteor.userId()));
    },
    action() {
